...
function growthTimelinePanel() {
  ...
  const current = plan.stages.find(s => s.id === plan.currentStage) || plan.stages[0];
  return `<section class="growth-timeline simple-timeline unified-growth" aria-labelledby="growth-timeline-title">
    <header><div><span class="strategy-eyebrow">THE STRATEGY AT A GLANCE</span><h2 id="growth-timeline-title">Growth Plan</h2><p>Find the right creators. Help them make a video. Repeat what earns real use.</p></div><span class="strategy-status">Organic pilot · preparation</span></header>
    <ol class="strategy-flow" aria-label="Growth strategy flow">
      <li><span class="strategy-flow-label"><span aria-hidden="true">01</span> What We Know</span><h3>Real use comes first</h3><p>Clicks show interest. First exports, repeat use and paying customers show value.</p><small>Customer response is still unproven.</small></li>
      <li><span class="strategy-flow-label"><span aria-hidden="true">02</span> Where We Find Customers</span><h3>Android reaction creators</h3><p>Start with qualified creators and communities. Broaden through Shorts, Reels and TikTok.</p><small>Search and the Play listing support discovery.</small></li>
      <li><span class="strategy-flow-label"><span aria-hidden="true">03</span> How We Reach Them</span><h3>Invite → show → help</h3><p>Personal invitations, an authentic demo and guided first-video help.</p><small>Confirm support and approval before delivery.</small></li>
      <li><span class="strategy-flow-label"><span aria-hidden="true">04</span> What We Do Next</span><h3>${esc(current.label)}</h3><p>${esc(current.next)}</p><small>Proof and support setup can run in parallel.</small></li>
    </ol>
    <div class="strategy-sequence-heading"><h3>Pilot sequence</h3><span>Select a step for its next action</span></div>
